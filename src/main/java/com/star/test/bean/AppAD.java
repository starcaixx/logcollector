...
/**
 * @author star
 * @create 2019-03-01 19:48
 */
public class AppAD {
    private String entry;//入口：商品列表页=1，应用首页-2，商品详情页-3
    private String action;//动作：请求广告-1，去缓存广告-2，广告位展示-3，广告展示-4，广告点击-5
    private String content;//状态：成功=1，失败-2
    private String detail;//失败码，没有则上报空
    private String source;//广告来源：admob-1,facebook-2,adx-3,vk-4
    private String behavior;//用户行为：主动获取广告-1，被动获取广告-2
    private String newstype;//1-图文，2-图集，3-段子，4-GIF，5-视频，6-调查，7-纯文，8-视频+图文，9-GIF+图文，0-其他
